...
// CHECK: [[v4ulong_4294967295:%[0-9]+]] = OpConstantComposite %v4ulong %ulong_4294967295 %ulong_4294967295 %ulong_4294967295 %ulong_4294967295
...
// CHECK-NEXT: [[and1:%[0-9]+]] = OpBitwiseAnd %ulong [[e]] %ulong_4294967295
// CHECK-NEXT: [[uconv1:%[0-9]+]] = OpUConvert %uint [[and1]]
...
// CHECK-NEXT: [[and1:%[0-9]+]] = OpBitwiseAnd %v4ulong [[f]] [[v4ulong_4294967295]]
// CHECK-NEXT: [[uconv1:%[0-9]+]] = OpUConvert %v4uint [[and1]]
